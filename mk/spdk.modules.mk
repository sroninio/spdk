...
FSDEV_MODULES_LIST = fsdev fsdev_aio fsdev_nfs
FSDEV_MODULES_PRIVATE_LIBS = $(shell pkg-config --libs glib-2.0)
FSDEV_MODULES_PRIVATE_LIBS += -L$(SPDK_ROOT_DIR)/module/fsdev/aio -lnfs
...
SYS_LIBS += $(BLOCKDEV_MODULES_PRIVATE_LIBS)  $(FSDEV_MODULES_PRIVATE_LIBS)

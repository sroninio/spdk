...
run_test "accel_copy_check_crc32c" $SPDK_EXAMPLE_DIR/accel_perf -t 1 -y -q 64 -w copy_check_crc32c -m 0xf -c $testdir/accel_mlx5.json
...
run_test "accel_mlx5_copy_check_crc32c" $SPDK_EXAMPLE_DIR/accel_mlx5_test -t 1 -q 64 -w copy_check_crc32c -m 0xf -c $testdir/accel_mlx5.json
...
run_test "accel_mlx5_check_crc32c" $SPDK_EXAMPLE_DIR/accel_mlx5_test -t 1 -q 128 -w check_crc32c -m 0xf -c $testdir/accel_mlx5.json
run_test "accel_mlx5_copy_check_crc32c" $SPDK_EXAMPLE_DIR/accel_mlx5_test -t 1 -q 128 -w copy_check_crc32c -m 0xf -c $testdir/accel_mlx5.json

run_test "accel_mlx5_check_crc32c_error" $SPDK_EXAMPLE_DIR/accel_mlx5_test -t 1 -q 1 -w check_crc32c -m 0x1 -f -c $testdir/accel_mlx5.json
run_test "accel_mlx5_copy_check_crc32c_error" $SPDK_EXAMPLE_DIR/accel_mlx5_test -t 1 -q 1 -w copy_check_crc32c -m 0x1 -f -c $testdir/accel_mlx5.json

...
static void
_spdk_fsdev_op_lseek_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	struct spdk_io_channel *ch = cb_arg;

	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_lseek_cpl_cb,
...
int
spdk_fsdev_op_lseek(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch,
		    ...
		    void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_lseek_cb, ch,
					 SPDK_FSDEV_OP_LSEEK);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
_spdk_fsdev_op_lookup_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_lookup_cpl_cb, fsdev_io->u_out.lookup.fobject,
...
static void
_spdk_fsdev_op_syncfs_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	struct spdk_io_channel *ch = cb_arg;

	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_syncfs_cpl_cb);

	fsdev_io_free(fsdev_io);
}

int
spdk_fsdev_op_syncfs(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch,
		     uint64_t unique, struct spdk_fsdev_file_object *fobject,
		     ...
		     spdk_fsdev_op_syncfs_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_syncfs_cb, ch,
	...
	fsdev_io->u_in.syncfs.fhandle = fhandle;
...
static void
_spdk_fsdev_op_access_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	struct spdk_io_channel *ch = cb_arg;

	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_access_cpl_cb,
		     ...
		     void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_access_cb, ch,
...
static void
_spdk_fsdev_op_ioctl_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	struct spdk_io_channel *ch = cb_arg;

	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_ioctl_cpl_cb,
...
int
spdk_fsdev_op_ioctl(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch,
		    uint64_t unique, struct spdk_fsdev_file_object *fobject,
		    ...
		    void *argp, spdk_fsdev_op_ioctl_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_ioctl_cb, ch,
					 SPDK_FSDEV_OP_IOCTL);
		     ...
		     spdk_fsdev_op_forget_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_forget_cb, ch,
...
int
spdk_fsdev_op_getattr(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		      ...
		      spdk_fsdev_op_getattr_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_getattr_cb, ch,
...
int
spdk_fsdev_op_setattr(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		      struct spdk_fsdev_file_object *fobject, struct spdk_fsdev_file_handle *fhandle,
		      ...
		      spdk_fsdev_op_setattr_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_setattr_cb, ch,
...
int
spdk_fsdev_op_readlink(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		       struct spdk_fsdev_file_object *fobject, spdk_fsdev_op_readlink_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_readlink_cb, ch,
...
_spdk_fsdev_op_symlink_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_symlink_cpl_cb, fsdev_io->u_out.symlink.fobject,
...
int
spdk_fsdev_op_symlink(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		      struct spdk_fsdev_file_object *parent_fobject, const char *target, const char *linkpath,
		      uid_t euid, gid_t egid, spdk_fsdev_op_symlink_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_symlink_cb, ch,
...
_spdk_fsdev_op_mknod_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_mknod_cpl_cb, fsdev_io->u_out.mknod.fobject,
		    ...
		    uid_t euid, gid_t egid, spdk_fsdev_op_mknod_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_mknod_cb, ch,
					 SPDK_FSDEV_OP_MKNOD);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
_spdk_fsdev_op_mkdir_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_mkdir_cpl_cb, fsdev_io->u_out.mkdir.fobject,
		    ...
		    uid_t euid, gid_t egid, spdk_fsdev_op_mkdir_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_mkdir_cb, ch,
					 SPDK_FSDEV_OP_MKDIR);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
		     ...
		     spdk_fsdev_op_unlink_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_unlink_cb, ch,
		    ...
		    spdk_fsdev_op_rmdir_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_rmdir_cb, ch,
					 SPDK_FSDEV_OP_RMDIR);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
		     ...
		     uint32_t flags, spdk_fsdev_op_rename_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_rename_cb, ch,
...
_spdk_fsdev_op_link_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_link_cpl_cb, fsdev_io->u_out.link.fobject,
		   ...
		   const char *name, spdk_fsdev_op_link_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_link_cb, ch,
					 SPDK_FSDEV_OP_LINK);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
_spdk_fsdev_op_open_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_open_cpl_cb, fsdev_io->u_out.open.fhandle);
...
spdk_fsdev_op_open(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		   ...
		   spdk_fsdev_op_open_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_open_cb, ch,
					 SPDK_FSDEV_OP_OPEN);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
		   ...
		   spdk_fsdev_op_read_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_read_cb, ch,
					 SPDK_FSDEV_OP_READ);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
		    ...
		    spdk_fsdev_op_write_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_write_cb, ch,
					 SPDK_FSDEV_OP_WRITE);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
_spdk_fsdev_op_statfs_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_statfs_cpl_cb, &fsdev_io->u_out.statfs.statfs);
		     ...
		     struct spdk_fsdev_file_object *fobject, spdk_fsdev_op_statfs_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_statfs_cb, ch,
...
int
spdk_fsdev_op_release(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		      struct spdk_fsdev_file_object *fobject, struct spdk_fsdev_file_handle *fhandle,
		      spdk_fsdev_op_release_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_release_cb, ch,
		    ...
		    spdk_fsdev_op_fsync_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_fsync_cb, ch,
					 SPDK_FSDEV_OP_FSYNC);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
int
spdk_fsdev_op_setxattr(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		       struct spdk_fsdev_file_object *fobject, const char *name, const char *value, size_t size,
		       uint32_t flags, spdk_fsdev_op_setxattr_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_setxattr_cb, ch,
		       ...
		       spdk_fsdev_op_getxattr_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_getxattr_cb, ch,
...
int
spdk_fsdev_op_listxattr(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
			struct spdk_fsdev_file_object *fobject, char *buffer, size_t size,
			spdk_fsdev_op_listxattr_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_listxattr_cb, ch,
...
int
spdk_fsdev_op_removexattr(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
			  struct spdk_fsdev_file_object *fobject, const char *name,
			  spdk_fsdev_op_removexattr_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_removexattr_cb, ch,
...
spdk_fsdev_op_flush(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		    struct spdk_fsdev_file_object *fobject, struct spdk_fsdev_file_handle *fhandle,
		    spdk_fsdev_op_flush_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_flush_cb, ch,
					 SPDK_FSDEV_OP_FLUSH);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
_spdk_fsdev_op_opendir_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_opendir_cpl_cb, fsdev_io->u_out.opendir.fhandle);

	fsdev_io_free(fsdev_io);
}

int
spdk_fsdev_op_opendir(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		      struct spdk_fsdev_file_object *fobject, uint32_t flags,
		      spdk_fsdev_op_opendir_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_opendir_cb, ch,
...
{
	spdk_fsdev_op_readdir_entry_cb *usr_entry_cb_fn = fsdev_io->u_in.readdir.usr_entry_cb_fn;
	struct spdk_io_channel *ch = cb_arg;
...
int
spdk_fsdev_op_readdir(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		      ...
		      spdk_fsdev_op_readdir_entry_cb entry_cb_fn, spdk_fsdev_op_readdir_cpl_cb cpl_cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cpl_cb_fn, cb_arg,
					 _spdk_fsdev_op_readdir_emum_clb, ch, SPDK_FSDEV_OP_READDIR);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
	...
	fsdev_io->u_in.readdir.entry_cb_fn = _spdk_fsdev_op_readdir_entry_clb;
...
int
spdk_fsdev_op_releasedir(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
			 struct spdk_fsdev_file_object *fobject, struct spdk_fsdev_file_handle *fhandle,
			 spdk_fsdev_op_releasedir_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_releasedir_cb, ch,
...
int
spdk_fsdev_op_fsyncdir(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		       struct spdk_fsdev_file_object *fobject, struct spdk_fsdev_file_handle *fhandle, bool datasync,
		       spdk_fsdev_op_fsyncdir_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_fsyncdir_cb, ch,
...
spdk_fsdev_op_flock(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		    ...
		    spdk_fsdev_op_flock_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_flock_cb, ch,
					 SPDK_FSDEV_OP_FLOCK);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
_spdk_fsdev_op_create_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_create_cpl_cb, fsdev_io->u_out.create.fobject,
...
spdk_fsdev_op_create(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
		     ...
		     mode_t umask, uid_t euid, gid_t egid, spdk_fsdev_op_create_cpl_cb cb_fn, void *cb_arg)
{
	struct spdk_fsdev_io *fsdev_io;

	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_create_cb, ch,
...
_spdk_fsdev_op_interrupt_cb(struct spdk_fsdev_io *fsdev_io, void *cb_arg)
{
	...
	CALL_USR_CLB(fsdev_io, ch, spdk_fsdev_op_abort_cpl_cb);
		    ...
		    uint64_t unique_to_abort, spdk_fsdev_op_abort_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, 0, cb_fn, cb_arg, _spdk_fsdev_op_interrupt_cb, ch,
					 SPDK_FSDEV_OP_ABORT);
	if (!fsdev_io) {
		return -ENOBUFS;
	}
...
int
spdk_fsdev_op_fallocate(struct spdk_fsdev_desc *desc, struct spdk_io_channel *ch, uint64_t unique,
			struct spdk_fsdev_file_object *fobject, struct spdk_fsdev_file_handle *fhandle,
			...
			spdk_fsdev_op_fallocate_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_fallocate_cb, ch,
			      ...
			      spdk_fsdev_op_copy_file_range_cpl_cb cb_fn, void *cb_arg)
{
	...
	fsdev_io = fsdev_io_get_and_fill(desc, ch, unique, cb_fn, cb_arg, _spdk_fsdev_op_copy_file_range_cb,
					 ch,
